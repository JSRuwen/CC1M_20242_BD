...
insert into fornecederos(cod_forn, nome_forn, telefone_forn, contato_forn) values
(1, 'Carrefour', '27-999999999', 'contatocarrefour@gmail.com'),
(2, 'Pão de Açúcar', '27-988888888', 'contatopaoaçucar@gmail.com'),
(3, 'Extra', '27-977777777', 'contatoextra@gmail.com'),
(4, 'Leroy Merlin', '27-966666666', 'contatoleroymerlin@gmail.com'),
(5, 'Magazine Luiza', '27-955555555', 'contatomagazineluiza@gmail.com');
...
insert into filiais(cod_filial, nome_filial, capacidade_filial, codpostal_filial) values
(2, 'Porto Seguro', '2000kg', '29080357'),
(3, 'Vila Verde', '1800kg', '29080468'),
(4, 'Maravilha', '2200kg', '29080579'),
(5, 'São José', '1700kg', '29080680');

update filiais set nome_filial = 'Vila Verde' where nome_filial = 'Mabel';

delete from filiais where nome_filial = 'Mabel';
...
insert into produtos(cod_prod, nome_prod, codpostal_filial) values
(1, 'Alcobaça', '27-988999999', 'contatoalcobaca@gmail.com'),
(2, 'Porto Seguro', '27-987888888', 'contatopseguro@gmail.com'),
(3, 'Vila Verde', '27-986777777', 'contatomabel@gmail.com'),
(4, 'Maravilha', '27-985666666', 'contatomaravilha@gmail.com'),
(5, 'São José', '27-984555555', 'contatosaojose@gmail.com');

update produtos set nome_prod = 'Vila Verde' where nome_prod = 'Mabel';
